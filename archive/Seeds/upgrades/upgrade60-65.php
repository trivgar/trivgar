...
$db->sql_query("CREATE TABLE ".$prefix."_users_temp (user_id INT( 10 ) DEFAULT '0'AUTO_INCREMENT PRIMARY KEY, username VARCHAR( 25 ) NOT NULL, user_email VARCHAR(255) NOT NULL, user_password VARCHAR(40) NOT NULL, user_regdate VARCHAR(20) NOT NULL, check_num VARCHAR(50) NOT NULL, time VARCHAR(14) NOT NULL)");
