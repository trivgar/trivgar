...
$i++;
$cfg['Servers'][$i]['host']          = 'mysql.seedsofpeace.com'; // MySQL hostname
$cfg['Servers'][$i]['port']          = '';          // MySQL port - leave blank for default port
$cfg['Servers'][$i]['socket']        = '';          // Path to the socket - leave blank for default socket
$cfg['Servers'][$i]['connect_type']  = 'tcp';       // How to connect to MySQL server ('tcp' or 'socket')
$cfg['Servers'][$i]['compress']      = FALSE;       // Use compressed protocol for the MySQL connection
                                                    // (requires PHP >= 4.3.0)
$cfg['Servers'][$i]['controluser']   = 'trivgar';          // MySQL control user settings
                                                    // (this user must have read-only
$cfg['Servers'][$i]['controlpass']   = 'forever';          // access to the "mysql/user"
                                                    // and "mysql/db" tables)
$cfg['Servers'][$i]['auth_type']     = 'config';    // Authentication method (config, http or cookie based)?
$cfg['Servers'][$i]['user']          = 'trivgar';      // MySQL user
$cfg['Servers'][$i]['password']      = 'forever';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'triv_nuke';          // If set to a db-name, only
...
$i++;
$cfg['Servers'][$i]['host']            = 'mysql.seedsofpeace.com';
$cfg['Servers'][$i]['port']            = '';
...
$cfg['Servers'][$i]['user']            = 'trivgar';
$cfg['Servers'][$i]['password']        = 'forever';
$cfg['Servers'][$i]['only_db']         = 'triv_nuke';
