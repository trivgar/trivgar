...
/* 							    */
/*							    */
/*  Nice_Blue Theme for PHP-Nuke 6.0  by                    */
/*  NukeStars.com                                           */
/*							    */	
/************************************************************/
...
include("themes/Nice_Blue/tables.php");
...
function themefooter() {
    ...
    if ($index == 1) {
	$tmpl_file = "themes/Nice_Blue/center_right.html";
	$thefile = implode("", file($tmpl_file));
	$thefile = addslashes($thefile);
	$thefile = "\$r_file=\"".$thefile."\";";
	eval($thefile);
    ...
    $tmpl_file = "themes/Nice_Blue/footer.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
    ...
    $tmpl_file = "themes/Nice_Blue/story_page.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
...
function themesidebox($title, $content) {
    $tmpl_file = "themes/Nice_Blue/blocks.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
