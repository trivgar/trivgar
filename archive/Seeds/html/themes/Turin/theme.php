<?php
/*********************************************************************/
/* Theme generated with Theme-editor 1.3 beta(modified by dezina.com)*/
...
echo "<!----- Start body ----->\n";
echo "<body>\n";
echo "<table width=772 border=0 align=center cellspacing=1 cellpadding=0>\n";
echo "<tr><td>\n";
echo "<table width=772 border=0 align=center cellspacing=1 cellpadding=0>\n";
/****************************** logo iniziale **************************/
global $bglogo, $imgcollogo;
$bglogo="#FFFFFF"; $imgcollogo="0";
echo "<tr>\n";
echo "<td>\n";
...
$bgbottom="#FFFFFF"; $imgcolbottom="0";
  echo "<tr>\n";
  echo "<td>\n";
...
$block="F"; $topheight="18"; $botheight="18"; $tabheight="37"; $leftwidth="14"; $rightwidth="14"; 
if ($table >100) {
  if ($linksurvey == 1) {
      $tablewidth="100%"; 
       } else {
...
$boxtable="#FFFFFF"; $boxtitle="#99CCFF"; $boxbg="#cccccc"; $typeuse="B";
...
$block="F"; $topheight="18"; $botheight="18";$articletabheight="37"; $leftwidth="14"; $rightwidth="14"; 
...
global $themename,$topheight,$botheight,$tabheight,$leftwidth,$rightwidth,$tablewidth,$themeimage;
global $boxtable,$boxtitle,$boxbg, $block, $typeuse;
$block="G"; $topheight="18"; $botheight="18";$indextabheight=""; $leftwidth="14"; $rightwidth="14"; 
