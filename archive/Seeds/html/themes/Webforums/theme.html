...
$bgcolor7 = "#006699";  # Trim line that surrounds each block
$bgcolor8 = "#c2cdd6";  # Left and right block title area background color
$bgcolor9 = "#c2cdd6";  # Center block title area background color???
...
function themeheader() {
    ...
    echo "<table bgcolor=\"$bgcolor6\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" width=\"100%\">
          <tr>
                <td>
                        <a href=\"index.php\">
                        <img src=\"themes/$thename/images/wflogo.gif\" border=\"0\" alt=\""._WELCOMETO." $sitename\" align=\"left\"></a>
