...
/* PurpleOdyssey Theme Mod by MaxG, http://globlenet.com/   */
...
include("themes/PurpleOdyssey/tables.php");
...
function themeheader() {
    ...
    echo "<body bgcolor=\"#550847\" text=\"#000000\" link=\"#004080\" vlink=\"#004080\" alink=\"#004080\">"
    ."<!-- PurpleOdyssey Theme Mod By, MaxG at http://www.globlenet.com/ support@globlenet.com -->\n\n\n\n";
    if ($banners) {
	include("banners.php");
    }
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
	...
	if($informant != "") {
	    $content = "<a href=\"modules.php?name=Your_Account$amp;op=userinfo&amp;uname=$informant\">$informant</a> ";
	} else {
	    $content = "$anonymous ";
	}
...
function themesidebox($title, $content) {
    $tmpl_file = "themes/PurpleOdyssey/blocks.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
