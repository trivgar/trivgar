...
function fadeout(element) {
    ...
    fade(152,152,152, 160,208,232, 20, 1, element);
}

function fadein(element) {

    fade(160,208,232, 152,152,152, 12, 1, element);
}

function fadeIn2(id){
	fade(152,152,152, 160,208,232, 25, 1, id);
}

function fadeOut2(id){
	fade(160,208,232, 152,152,152, 29, 1, id);
}