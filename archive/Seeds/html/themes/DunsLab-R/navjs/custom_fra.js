...
addMainItem("index.php","Accueil",61,"center",""); 
	...
	addSubmenuItem("modules.php?op=modload&name=Search&file=index","Rechercher","");
	addSubmenuItem("modules.php?name=Stories_Archive&sa=show_all","Tous Les Articles","");
	addSubmenuItem("modules.php?op=modload&name=Topics&file=index","Tous Les Sujets","");
	addSubmenuItem("modules.php?op=modload&name=Submit_News&file=index","Soumettre Un Article","");
	addSubmenuItem("modules.php?op=modload&name=FAQ&file=index","FAQ","");
	addSubmenuItem("modules.php?op=modload&name=Top","Top 10","");
	addSubmenuItem("modules.php?op=modload&name=Statistics","Statistiques","");




addMainItem("modules.php?op=modload&name=Downloads&file=index"," T&eacute;l&eacute;chargements ",120,"center",""); 
	...
	addSubmenuItem("modules.php?name=Downloads&d_op=NewDownloads","Nouveautés","");
	// addSubmenuItem("modules.php?op=modload&name=Web_Links&file=index","Autres Liens","");
...
// addMainItem("modules.php?op=modload&name=XForum&file=index","Forums",65,"center",""); 
	...
	// addSubmenuItem("modules.php?op=modload&name=XForum&file=forumdisplay&fid=7","Blocs Post-Nuke","");
	// addSubmenuItem("modules.php?op=modload&name=XForum&file=forumdisplay&fid=9","Modules Post-Nuke","");
	// addSubmenuItem("modules.php?op=modload&name=XForum&file=indexnav&gid=14","Load Process","");



addMainItem("","Membres",70,"center",""); 

	defineSubmenuProperties(112,"right","right");

	addSubmenuItem("modules.php?op=modload&name=Private_Messages","Messagerie","");
	addSubmenuItem("modules.php?name=Your_Account","Votre compte","");
	addSubmenuItem("modules.php?op=modload&name=Members_List&file=index","Annuaire Du Site","");
	addSubmenuItem("modules.php?op=modload&name=Recommend_Us&file=index","Nous Recommander","");
	




// addMainItem("","Plus...",58,"center",""); 

	// defineSubmenuProperties(180,"right","right");
	// addSubmenuItem("modules.php?op=modload&name=NqtAdm&file=index","Network Query Tools","");
	// addSubmenuItem("modules.php?op=modload&name=EU-Weather&file=index","Prévisions Météo à 48H","");
	// addSubmenuItem("modules.php?op=modload&name=PP-News&file=index&choix=inscription_user","S\'inscrire &agrave; la NewsLetter","");
	// addSubmenuItem("modules.php?op=modload&name=AvantGo&file=index","AvantGo","");


addMainItem("","Partenaires",94,"center",""); 
	...
	addSubmenuItem("http://www.boomtchak.net","BoomTchak","_blank","Le site français de référence pour PHP-Nuke et PostNuke");
