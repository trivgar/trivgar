...
function themeheader() {
    ...
    echo "<body bgcolor=\"#FFFFFF\" text=\"#000000\" link=\"#666666\" vlink=\"#666666\" alink=\"#666666\" marginheight=\"0\" 
...
."<table bgcolor=\"#E7E7E7\" cellpadding=\"0\" cellspacing=\"1\" width=\"99%\" class=\"forumline\">\n"
	...
	."<td bgcolor=\"#F2F2F2\" class=\"row1\" valign=\"middle\" width=\"280\" height=\"70\">\n"
    ."<a href=\"http://nuke.newzworld.com\"><img src=\"images/logo.gif\" border=\"none\"></a>\n"
              ."</td>\n"
	."<td background=\"/themes/softIndustrial/images/cellpic01.gif\" class=\"catHead\" height=\"28\" bgcolor=\"#D1D1D1\" 
 align=\"right\" width=\"500\" height=\"70\"><center>\n"
."NewzWorld Network<br>"
        ."Choose One:"
        ."<FORM ACTION=\"\" METHOD=\"GET\">
<select name=\"site\" onChange=\"top.location.href=this.options[this.selectedIndex].value\">
<option value=\"http://nuke.newzworld.com/\" SELECTED>Nuke NewzWorld</option>
<option value=\"\"> ----------- </option>
<option value=\"http://www.newzworld.com\">NewzWorld</option>
</select>
</FORM>\n";
	...
	."<tr>\n"
	."<td background=\"/themes/softIndustrial/images/cellpic01.gif\" class=\"catHead\" height=\"28\" bgcolor=\"#D1D1D1\" 	align=\"left\" colspan=\"2\">\n"
	...
	."</tr>\n"
	."<tr>\n"
	."<td colspan=2 background=\"/themes/softIndustrial/images/cellpic01.gif\" 
...
while(list($sid, $title) = sql_fetch_row($result, $dbi)) {
                echo "<a
href=\"http://nuke.newzworld.com/modules.php?name=News&file=article&sid=$sid\">$title -- </a>";
        }
...
function themefooter() {
    ...
    echo "</td>\n"
        ...
        ."<table bgcolor=\"#E7E7E7\" cellpadding=\"0\" cellspacing=\"1\" width=\"99%\" class=\"forumline\">\n"
        ."<tr align=\"center\">\n"
        ."<td width=\"100%\" colspan=\"3\" background=\"/themes/softIndustrial/images/cellpic01.gif\" class=\"catHead\" height=\"28\" bgcolor=\"#D1D1D1\" align=\"center\">\n"
."<span=\"mainmenu\"></span>\n"
	."</td>\n"
	."</tr>\n"
	."<tr>\n"
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
	...
	."<td>\n\n"
	."<!----- Story Box Title ----->\n"
	."<table border=\"0\" cellpadding=\"3\" cellspacing=\"0\" background=\"/themes/softIndustrial/images/blocktitle.gif\" 
height=\"28\" bgcolor=\"#D1D1D1\" width=\"100%\">\n"
	."<tr>\n"
	."<td align=\"center\">\n"
	...
	."<tr>\n"
	."<td>\n"
	."<table border=\"0\" background=\"/themes/softIndustrial/images/cellpic01.gif\" cellpadding=\"2\" cellspacing=\"0\" width=\"100%\" bgcolor=\"#F2F2F2\">\n"
	."<tr>\n"
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
	...
	<tr><td>\n"
        ...
        ."<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" bgcolor=\"#F2F2F2\" width=\"100%\"><tr><td align=\"left\" background=\"/themes/softIndustrial/images/cellpic01.gif\">\n"
...
function themesidebox($title, $content) {
	...
	."<tr>\n"
	."<td background=\"/themes/softIndustrial/images/blocktitle.gif\" height=\"28\" bgcolor=\"#D1D1D1\" align=\"left\">\n"
