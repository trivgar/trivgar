...
$bgcolor3 	= "#000000";
$bgcolor4 	= "#003366";
$bgcolor5 	= "SFX/images/bar.gif";
$textcolor1 	= "#FFFFCC";
$textcolor2 	= "#FFFFFF";

function OpenTable() {
    global $bgcolor1, $bgcolor5;
    echo "<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"006666\"><tr><td>\n";
    echo "<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"8\" bgcolor=\"$bgcolor1\"><tr><td>\n";
}

function OpenTable2() {
    global $bgcolor1, $bgcolor2;
    echo "<table border=\"0\" cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"006666\" align=\"center\"><tr><td>\n";
...
function themeheader() {
    ...
    global $slogan;
    echo "<body bgcolor=\"000000\" text=\"#C5C5C5\" link=\"FFFFFF\" vlink=\"FFFFFF\">";
    if ($banners) {
	include("banners.php");
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
    ...
    echo "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\" bgcolor=\"006666\" width=\"100%\"><tr><td>"
        ."<table border=\"0\" cellpadding=\"3\" cellspacing=\"1\" width=\"100%\"><tr><td bgcolor=\"006666\" background=\"themes/SFX/images/barra.gif\">"
        ."<b>$title</b><br>"
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
	...
	echo "
	<table border=0 cellpadding=0 cellspacing=0 align=center bgcolor=006666 width=100%><tr><td>
	<table border=0 cellpadding=3 cellspacing=1 width=100%><tr><td bgcolor=006666 background=\"themes/SFX/images/barra.gif\">
	<b>$title</b>
	</td></tr><tr><td bgcolor=000000>
...
function themesidebox($title, $content) {
    echo "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"150\" bgcolor=\"006666\"><tr><td>"
        ."<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\"><tr><td bgcolor=\"000000\" background=\"themes/SFX/images/barra.gif\">"
