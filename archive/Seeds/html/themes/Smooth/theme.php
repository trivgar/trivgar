...
$thename = "Smooth";
    ...
    $tmpl_file = "themes/$thename/header.html";
    ...
    print $r_file;
    blocks(left);
    $tmpl_file = "themes/$thename/left_center.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
...
function themefooter() {
    global $index, $sitename, $slogan, $foot1, $foot2, $foot3, $foot4;

$thename = "Smooth";

    if ($index == 1) {
	$tmpl_file = "themes/$thename/center_right.html";
	$thefile = implode("", file($tmpl_file));
	$thefile = addslashes($thefile);
	$thefile = "\$r_file=\"".$thefile."\";";
	eval($thefile);
    ...
    $tmpl_file = "themes/$thename/footer.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
...
echo "$sid";
	$reads = ""._READS."";
	$postedby = ""._POSTEDBY." ";
    $postedon = ""._ON." $time $timezone";
    $posted = ""._POSTEDBY." ";
    $posted .= get_author($aid);
    $posted .= " "._ON." $time $timezone ($counter "._READS.")";
    $tmpl_file = "themes/$thename/story_home.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
...
$thename = "Smooth";
    ...
    $tmpl_file = "themes/$thename/story_page.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
...
$thename = "Smooth";
    ...
    $tmpl_file = "themes/$thename/blocks.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
    eval($thefile);
