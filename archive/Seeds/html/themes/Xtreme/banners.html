...
include($dtheme);
    echo"
    <html>
    <Title>User Banners Administration for $sitename</title>
    <LINK REL=\"StyleSheet\" HREF=\"themes/$Default_Theme/style/style.css\" TYPE=\"text/css\">
    <body bgcolor=\"$bgcolor1\" text=\"$textcolor2\" link=\"#006666\" vlink=\"#006666\">
    <center><h3>User Banners Administration</h3></center>
    <center><br><br><br><br>
    <table width=\"200\" cellpadding=\"0\" cellspacing=\"1\" border=\"0\" bgcolor=\"$bgcolor1\"><tr><td>
    <table width=\"100%\" cellpadding=\"5\" cellspacing=\"1\" border=\"0\" bgcolor=\"$bgcolor4\"><tr><td bgcolor=\"#$bgcolor2\">
...
include("config.php");
$dtheme ="themes/$Default_Theme/theme.php";
include($dtheme);    global $prefix, $dbi, $sitename;
    ...
    <Title>User Banners Administration for $sitename</title>
    <LINK REL=\"StyleSheet\" HREF=\"themes/$Default_Theme/style/style.css\" TYPE=\"text/css\">
    <body bgcolor=\"$bgcolor1\" text=\"$textcolor2\" link=\"#C0C0C0\" vlink=\"#C0C0C0\">
    <center><h3>User Banners Administration</h3></center>
    <center>
    <table border=\"0\" width=\"100%\" cellpadding=\"0\" cellspacing=\"1\" bgcolor=\"$bgcolor4\"><tr><td>
    <table border=\"0\" width=\"100%\" cellpadding=\"1\" cellspacing=\"1\" bgcolor=\"$bgcolor1\"><tr><td>
    <font class=\"option\">
    <center><b>Current Active Banners for $name</b></center><br>
    </font>
    <table bgcolor=\"$bgcolor4\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\"><tr>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>ID</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Imp. Made</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Imp. Total</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Imp. Left</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Clicks</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>% Clicks</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Functions</b></td><tr>";
    ...
    while(list($bid, $imptotal, $impmade, $clicks, $date) = sql_fetch_row($result, $dbi)) {
        ...
        echo "
        <td bgcolor=\"$bgcolor1\" align=\"center\">$bid</td>
        <td bgcolor=\"$bgcolor1\" align=\"center\">$impmade</td>
        <td bgcolor=\"$bgcolor1\" align=\"center\">$imptotal</td>
	<td bgcolor=\"$bgcolor1\" align=\"center\">$left</td>
        ...
        <td bgcolor=\"$bgcolor1\" align=\"center\"><a href=\"banners.php?op=EmailStats&login=$login&cid=$cid&bid=$bid\">E-mail Stats</a></td><tr>";
    }
    echo "
    </table>
    <center><br><br>
    The Following are your running Banners in $sitename<br><br>";
...
/* Finnished Banners */
    ...
    <table bgcolor=\"$bgcolor4\" width=\"100%\" border=\"0\"><tr>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>ID</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Impressions</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Clicks</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>% Clicks</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Start Date</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>End Date</b></td>
    <td bgcolor=\"#$bgcolor2\"><font color=\"Black\"><center><b>Functions</b></td></tr>";
	...
	echo "
        ...
        <td bgcolor=\"$bgcolor1\" align=\"center\"><font color=\"White\">$impmade</td>
        <td bgcolor=\"$bgcolor1\" align=\"center\"><font color=\"White\">$clicks</td>
	<td bgcolor=\"$bgcolor1\" align=\"center\"><font color=\"White\">$percent%</td>
        <td bgcolor=\"$bgcolor1\" align=\"center\"><font color=\"White\">$date</td>
        <td bgcolor=\"$bgcolor1\" align=\"center\"><font color=\"White\">$dateend</td>
	<td bgcolor=\"$bgcolor1\" align=\"center\"><font color=\"White\"><a href=\"$imageurl\" target=\"new\">View Banner</a></td></tr>";
    }
echo "
