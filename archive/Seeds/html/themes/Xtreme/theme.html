...
include("themes/Xtreme/colors.php");

function OpenTable() {
    global $bgcolor1, $bgcolor5;
    echo "<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"CC0000\"><tr><td>\n";
    echo "<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"8\" bgcolor=\"$bgcolor1\"><tr><td>\n";
}

function OpenTable2() {
    global $bgcolor1, $bgcolor2;
    echo "<table border=\"0\" cellspacing=\"1\" cellpadding=\"0\" bgcolor=\"CC0000\" align=\"center\"><tr><td>\n";
...
function themeheader() {
    ...
    global $slogan;
    echo "<body bgcolor=\"000000\" text=\"C5C5C5\" link=\"FFFFFF\" vlink=\"FFFFFF\" topmargin=\"3\" leftmargin=\"5\" marginwidth=\"5\">";
    if ($banners) {
	include("banners.php");
	echo "<BR>";
    }
    ...
    $tmpl_file = "themes/Xtreme/header.html";
    ...
    echo "<table border=\"0 cellpadding=\"4\" cellspacing=\"0\" width=\"100%\" align=\"center\"><tr><td bgcolor=\"$bgcolor5\" \" \">"
        ."<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td valign=\"top\" width=\"150\" bgcolor=\"$bgcolor5\">";
    blocks(left);
...
function themefooter() {
    global $index;
    if ($index == 1) {
	echo "</td><td>&nbsp;&nbsp;</td><td valign=\"top\" bgcolor=\"$bgcolor5\">";
	blocks(right);
	echo "</td>";
    }
    echo "</td></tr></table></td></tr></table>";
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
    ...
    echo "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\" bgcolor=\"CC0000\" width=\"100%\"><tr><td>"
        ."<table border=\"0\" cellpadding=\"3\" cellspacing=\"1\" width=\"100%\"><tr><td bgcolor=\"CC0000\" background=\"themes/Xtreme/images/barra.gif\">"
        ."<b>$title</b><br>"
	."</font></td></tr><tr><td bgcolor=\"000000\">"
        ."<font class=\"tiny\">"
        .""._POSTEDBY." <b>";
    formatAidHeader($aid);
    echo "<a href=modules.php?name=News&amp;new_topic=$topic><img src=$tipath$topicimage border=\"0\" Alt=\"$topictext\" align=\"left\" hspace=\"10\" vspace=\"10\"></a>";
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
	...
	echo "
	<table border=0 cellpadding=0 cellspacing=0 align=center bgcolor=CC0000 width=100%><tr><td>
	<table border=0 cellpadding=3 cellspacing=1 width=100%><tr><td bgcolor=CC0000 background=\"themes/Xtreme/images/barra.gif\">
	<b>$title</b>
	</td></tr><tr><td bgcolor=000000>
...
function themesidebox($title, $content) {
    echo "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"180\" bgcolor=\"CC0000\"><tr><td>"
        ."<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\"><tr><td bgcolor=\"000000\" background=\"themes/Xtreme/images/barra.gif\">"
