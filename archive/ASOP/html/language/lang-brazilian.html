...
define("_PASTARTICLES","Artigos Antigos");
...
define("_ASREGISTERED","Você ainda não é Registrado em nosso Site? Você pode se registrar gratuitamente clicando <a href=\"modules.php?name=Your_Account\">aqui</a>. Como usuário registrado do site, você tem acesso a diversos serviços exclusivos.");
define("_MENUFOR","Menu");
define("_NOBIGSTORY","Não há histórias publicadas hoje.");
...
define("_CURRENTLY","Estão on-line atualmente,");
define("_GUESTS","visitante(s) ");
define("_MEMBERS","usuário(s)");
define("_YOUARELOGGED","Você está logado como");
define("_YOUHAVE","Você possui");
define("_PRIVATEMSG","mensagem(ns) em sua Caixa de Entrada.");
define("_YOUAREANON","Você ainda não é registrado em nosso Site. Você pode se registrar gratuitamente clicando <a href=\"modules.php?name=Your_Account\">aqui</a>");
define("_NOTE","Nota:");
define("_ADMIN","Admin.");
define("_WERECEIVED","Recebemos");
define("_PAGESVIEWS","pageviews desde");
...
define("_MODULEUSERS", "Desculpe-nos, mas esta seção do Site é exclusiva para Usuários Registrados <br><br>Você pode registrar-se gratuitamente clicando <a href=\"modules.php?name=Your_Account&op=new_user\">aqui</a>, e então você terá acesso a esta e outras seções exclusivas. Obrigado.<br><br>");
...
define("_THISISAUTOMATED","Este é um e-mail automático para avisá-lo(a) que os anúncios de seu Banner em nosso Site acabaram de terminar..");
define("_THERESULTS","Abaixo, segue um relatório de sua campanha:");
define("_TOTALIMPRESSIONS","Total de impressões realizadas:");
define("_CLICKSRECEIVED","Cliques recebidos:");
define("_IMAGEURL","Link para a imagem:");
define("_CLICKURL","Link para o clique:");
define("_ALTERNATETEXT","Texto alternativo:");
define("_HOPEYOULIKED","Esperamos que você tenha gostado do nosso serviço de anúncios. Você não gostaria de renovar a sua conta?");
define("_THANKSUPPORT","Obrigado por seu suporte");
define("_TEAM","Equipe");
define("_BANNERSFINNISHED","Banners já encerrados");
