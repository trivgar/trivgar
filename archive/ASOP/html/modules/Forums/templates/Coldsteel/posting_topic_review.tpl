...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline" style="border: 0px #006699 solid ">
	<tr>
		<th class="thTop" width="22%" height="26">{L_AUTHOR}</th>
	...
	<tr> 
		<td colspan="2" height="1" class="spaceRow"><img src="templates/Coldsteel/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	 <!-- END postrow -->
</table>
<!-- BEGIN switch_inline_mode -->
