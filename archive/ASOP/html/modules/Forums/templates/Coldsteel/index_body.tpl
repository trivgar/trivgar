...
<table width="100%" cellpadding="2" cellspacing="0" border="0" class="forumline">
  <tr> 
	<td background="templates/Coldsteel/images/catbg2.gif" colspan="6" height="28"><span class="cattitle">:: <a href="{catrow.U_VIEWCAT}" class="cattitle">{catrow.CAT_DESC} </a>::</span></td>
  </tr></table>
...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <tr>
  <td background="templates/Coldsteel/images/catbg3.gif" colspan="6" height=25>&nbsp;</th>
  </tr>
  <!-- END catrow -->
</table>
</tr></td></table>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	<td class="row1" align="center" valign="middle" rowspan="2"><img src="templates/Coldsteel/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" /></td>
...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
	<td width="20" align="center"><img src="templates/Coldsteel/images/folder_new.gif" alt="{L_NEW_POSTS}"/></td>
	<td><span class="gensmall">{L_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/Coldsteel/images/folder.gif" alt="{L_NO_NEW_POSTS}" /></td>
	<td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/Coldsteel/images/folder_lock.gif" alt="{L_FORUM_LOCKED}" /></td>
