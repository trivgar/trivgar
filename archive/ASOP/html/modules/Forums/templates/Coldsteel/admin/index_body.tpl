...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  <tr> 
	<th width="25%" nowrap="nowrap" height="25" class="th">{L_STATISTIC}</th>
	<th width="25%" height="25" class="th">{L_VALUE}</th>
	<th width="25%" nowrap="nowrap" height="25" class="th">{L_STATISTIC}</th>
	<th width="25%" height="25" class="th">{L_VALUE}</th>
  </tr>
  <tr> 
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  <tr> 
	<th width="20%" class="th" height="25">&nbsp;{L_USERNAME}&nbsp;</th>
	<th width="20%" height="25" class="th">&nbsp;{L_STARTED}&nbsp;</th>
	<th width="20%" class="th">&nbsp;{L_LAST_UPDATE}&nbsp;</th>
	<th width="20%" class="th">&nbsp;{L_FORUM_LOCATION}&nbsp;</th>
	<th width="20%" height="25" class="th">&nbsp;{L_IP_ADDRESS}&nbsp;</th>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="5" height="1" class="row3"><img src="../templates/Coldsteel/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
