...
function themeheader() {
	...
	."<img src=\"themes/deviantNuke/images/logo.gif\">\n"
	."</td>\n"
	."</tr>\n"
	."</table>\n\n"
	...
	."<td align=\"left\" valign=\"bottom\"><input type=\"image\" name=\"search\" src=\"themes/deviantNuke/images/search-button.gif\" width=\"52\" height=\"18\" border=\"0\">\n"
	."</td>\n"
	."</form>\n\n"
    ...
    $toplist = mysql_query("select topicid, topictext from $prefix"._topics." order by topictext", $dbi);
    echo "<select class=\"formtexts\" name=\"topic\"onChange='submit()'>\n"
	."<option value=\"\">"._ALLTOPICS."</option>\n";
    while(list($topicid, $topics) = mysql_fetch_row($toplist, $dbi)) {
    ...
    ."<tr>\n"
    ."<td width=\"16%\" bgcolor=\"#738278\" class=\"cellbox\" align=\"center\" style=\"cursor:hand\" onMouseOver=\"this.style.background='#96A096'\" onMouseOut=\"this.style.background='#738278'\" onClick=\"window.location.href='/'\"><a href=\"/\">"._MAIN."</a></td>\n"
    ."<td width=\"16%\" bgcolor=\"#738278\" class=\"cellbox\" align=\"center\" style=\"cursor:hand\" onMouseOver=\"this.style.background='#96A096'\" onMouseOut=\"this.style.background='#738278'\" onClick=\"window.location.href='modules.php?name=Topics'\"><a href=\"topics.php\">"._TOPICS."</a></td>\n"
    ."<td width=\"16%\" bgcolor=\"#738278\" class=\"cellbox\" align=\"center\" style=\"cursor:hand\" onMouseOver=\"this.style.background='#96A096'\" onMouseOut=\"this.style.background='#738278'\" onClick=\"window.location.href='modules.php?name=Downloads'\"><a href=\"download.php\">"._DOWNLOADS."</a></td>\n"
    ."<td width=\"16%\" bgcolor=\"#738278\" class=\"cellbox\" align=\"center\" style=\"cursor:hand\" onMouseOver=\"this.style.background='#96A096'\" onMouseOut=\"this.style.background='#738278'\" onClick=\"window.location.href='modules.php?name=Your_Account'\"><a href=\"user.php\">"._ACCOUNT."</a></td>\n"
    ."<td width=\"16%\" bgcolor=\"#738278\" class=\"cellbox\" align=\"center\" style=\"cursor:hand\" onMouseOver=\"this.style.background='#96A096'\" onMouseOut=\"this.style.background='#738278'\" onClick=\"window.location.href='modules.php?name=Submit_News'\"><a href=\"submit.php\">"._SUBMITNEWS."</a></td>\n"
    ."<td width=\"16%\" bgcolor=\"#738278\" class=\"cellbox\" align=\"center\" style=\"cursor:hand\" onMouseOver=\"this.style.background='#96A096'\" onMouseOut=\"this.style.background='#738278'\" onClick=\"window.location.href='top.php'\"><a href=\"modules.php?name=Top\">Top 10</a></td>\n"
    ."</tr>\n"
	."</table>\n"
	."</td>\n"
	."</tr>\n"
