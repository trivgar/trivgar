<?php
/* $Id: sqlvalidator.class.php,v 1.11 2003/01/16 07:37:46 robbat2 Exp $ */
...
*
* @version  $Id: sqlvalidator.class.php,v 1.11 2003/01/16 07:37:46 robbat2 Exp $
*/
    ...
    if (!function_exists('class_exists') || !class_exists('SOAP_Client')) {
        ...
        class PMA_SQLValidator {
            ...
            function PMA_SQLValidator()
            {
                ...
                $this->calling_program_version       = '$Revision: 1.11 $';
