 <table cellpadding="2" cellspacing="0" border="0" width="98%"  align="center">
  <tr> 
    <td valign="top"><img src="templates/icicle/images/posticon_normal_new.gif" border="0" align="absmiddle"> 
      <span class="largetext"><a href="index.php" class="largelink"><b>{SITENAME} 
...
<table cellpadding="0" cellspacing="0" border="0" width="98%" align="center">
  ...
  <tr> 
	  <td height="34" class="catrow" align="center"><span class="catrowtext">{L_ENTER_PASSWORD}</span></td>
  </tr>
  <tr> 
	<td class="row1"><table border="0" cellpadding="3" cellspacing="1" width="100%">
		  ...
		  <tr align="center"> 
			<td colspan="2">{S_HIDDEN_FIELDS}<input type="submit" name="login" value="{L_LOGIN}"></td>
		  </tr>
		  <tr align="center"> 
