...
<table cellpadding="0" cellspacing="0" border="0" width="98%" align="center">
  ...
  <table width="100%" cellpadding="7" cellspacing="1" border="0">
	      <tr align="center"> 
            <td colspan="7"height="34" class="catrow"><span class="catrowtext">{L_GROUP_INFORMATION}</span></td>
	</tr>
	<tr> 
	  <td class="row1" width="20%"><span class="mediumtext">{L_GROUP_NAME}:</span></td>
	  <td class="row2"><span class="mediumtext"><b>{GROUP_NAME}</b></span></td>
	</tr>
	<tr> 
	  <td class="row1" width="20%"><span class="mediumtext">{L_GROUP_DESC}:</span></td>
	  <td class="row2"><span class="mediumtext">{GROUP_DESC}</span></td>
	</tr>
	<tr> 
	  <td class="row1" width="20%"><span class="mediumtext">{L_GROUP_MEMBERSHIP}:</span></td>
	  <td class="row2"><span class="mediumtext">{GROUP_DETAILS} &nbsp;&nbsp;
	...
	<tr> 
	  ...
	  <td class="row2"><span class="mediumtext"><span class="mediumtext"><input type="radio" name="group_type" value="{S_GROUP_OPEN_TYPE}" {S_GROUP_OPEN_CHECKED}> {L_GROUP_OPEN} &nbsp;&nbsp;<input type="radio" name="group_type" value="{S_GROUP_CLOSED_TYPE}" {S_GROUP_CLOSED_CHECKED}>	{L_GROUP_CLOSED} &nbsp;&nbsp;<input type="radio" name="group_type" value="{S_GROUP_HIDDEN_TYPE}" {S_GROUP_HIDDEN_CHECKED}>	{L_GROUP_HIDDEN} &nbsp;&nbsp; <input type="submit" name="groupstatus" value="{L_UPDATE}"></span></span></td>
	</tr>
...
<table width="100%" cellpadding="7" cellspacing="1" border="0">
	<tr> 
	  <td height="35" class="toprow" align="center"><span class="toprowtext">{L_PM}</span></td>
	  <td height="35" class="toprow" align="center"><span class="toprowtext">{L_USERNAME}</span></td>
	  <td height="35" class="toprow" align="center"><span class="toprowtext">{L_POSTS}</span></td>
	  <td height="35" class="toprow" align="center"><span class="toprowtext">{L_FROM}</span></td>
	  <td height="35" class="toprow" align="center"><span class="toprowtext">{L_EMAIL}</span></td>
	  <td height="35" class="toprow" align="center"><span class="toprowtext">{L_WEBSITE}</span></td>
	  <td height="35" class="toprow" align="center"><span class="toprowtext">{L_SELECT}</span></td>
	</tr>

	<tr> 
	  <td height="34" class="catrow" colspan="8"><span class="catrowtext">{L_GROUP_MODERATOR}</span></td>
	</tr>

	<tr> 
	  <td class="row1" align="center"> {MOD_PM_IMG} </td>
	  <td class="row2" align="center"><span class="mediumtext"><a href="{U_MOD_VIEWPROFILE}" class="mediumlink">{MOD_USERNAME}</a></span></td>
	  <td class="row1" align="center" valign="middle"><span class="mediumtext">{MOD_POSTS}</span></td>
	  <td class="row2" align="center" valign="middle"><span class="mediumtext">{MOD_FROM}</span></td>
	...
	<tr> 
	  <td height="34" class="catrow" colspan="8"><span class="catrowtext">{L_GROUP_MEMBERS}</span></td>
	</tr>

	<!-- BEGIN member_row -->
	<tr> 
	  <td class="row1" align="center"> {member_row.PM_IMG} </td>
	  <td class="row2" align="center"><span class="mediumtext"><a href="{member_row.U_VIEWPROFILE}" class="mediumlink">{member_row.USERNAME}</a></span></td>
	  <td class="row1" align="center"><span class="mediumtext">{member_row.POSTS}</span></td>
	  <td class="row2" align="center"><span class="mediumtext"> {member_row.FROM} </span></td>
	  <td class="row1" align="center" valign="middle"><span class="mediumtext">{member_row.EMAIL_IMG}</span></td>
	  <td class="row2" align="center"> {member_row.WWW_IMG}</td>
	...
	<!-- BEGIN switch_mod_option -->
	<tr>
		<td height="34" class="catrow" colspan="8" align="right"><span class="catrowtext">
  ...
  <table width="98%" cellspacing="2" border="0" align="center" cellpadding="2">
    <tr>
		...
		<td align="right" valign="top"><span class="smalltext">{S_TIMEZONE}</span><br><span class="smalltext">{PAGINATION}</span></td>
	</tr>
</table>
