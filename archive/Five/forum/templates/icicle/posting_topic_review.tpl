...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
	...
	<td height="34" class="catrow" height="28" align="center"><b><span class="catrowtext">{L_TOPIC_REVIEW}</span></b></td>
	</tr>
	<tr>
...
<!-- END switch_inline_mode -->
 <table cellpadding="0" cellspacing="0" border="0" width="98%" align="center">
  <tr> 
    <td class="tableborder">
	  <table border="0" cellpadding="3" cellspacing="1" width="100%" style="border: 0px #006699 solid ">
        <tr> 
        ...
        <tr> 
          ...
          <td class="row2" height="28" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="100%"><img src="{postrow.MINI_POST_IMG}" alt="{postrow.L_MINI_POST_ALT"><span class="postdetails">{L_POSTED}: 
                  {postrow.POST_DATE}<span class="mediumtext">&nbsp;</span>&nbsp;&nbsp;&nbsp;{L_POST_SUBJECT}: 
