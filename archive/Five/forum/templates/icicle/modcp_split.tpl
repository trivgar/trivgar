...
<table cellpadding="0" cellspacing="0" border="0" width="98%" align="center">
  ...
  <table width="100%" cellpadding="7" cellspacing="1" border="0">
	      <tr align="center"> 
            <td height="34" class="catrow" colspan="3"><spanheight="34" class="catrow">{L_SPLIT_TOPIC}</span></td>
	</tr>
	<tr> 
	  <td class="row2" colspan="3" align="center"><span class="smalltext">{L_SPLIT_TOPIC_EXPLAIN}</span></td>
	</tr>
	<tr> 
	  <td class="row1" nowrap><span class="mediumtext">{L_SPLIT_SUBJECT}</span></td>
	  <td class="row2" colspan="2"><span class="smalltext"> 
	...
	<tr> 
	  ...
	  <td class="row2" colspan="2"><span class="smalltext">{S_FORUM_SELECT}</span></td>
	</tr>
	<tr> 
	  <td height="34" class="catrow" colspan="3" height="28"> 
	...
	<tr> 
	  <td height="35" class="toprow"><span class="toprowtext">{L_AUTHOR}</span></td>
	...
	<tr> 
	  ...
	  <td width="100%" valign="top" class="row2"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle"><img src="templates/icicle/images/icon_minipost.gif" alt="Post image icon"><span class="smalltext">{L_POSTED}: 
	  ...
	  <td width="5%" align="center" class="row2"><input type="checkbox" name="post_id_list[]" value="{postrow.POST_ID}"></td>
	</tr>
	<!-- END postrow -->
	<tr> 
	  <td height="34" class="catrow" colspan="3" height="28"> 
