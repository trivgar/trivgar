...
<table cellpadding="0" cellspacing="0" border="0" width="98%" align="center">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%">
	      <tr align="center"> 
            <td height="34" class="catrow" colspan="2" valign="middle"><span class="catrowtext">{L_SEND_PASSWORD}</span></td>
	</tr>
	<tr> 
	  <td class="row2" colspan="2"><span class="smalltext">{L_ITEMS_REQUIRED}</span></td>
	</tr>
	<tr> 
