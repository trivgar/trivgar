...
<table cellpadding="0" cellspacing="0" border="0" width="98%" align="center">
  <tr> 
    <td class="tableborder">
        <table width="100%" cellpadding="7" cellspacing="1" border="0">
          <tr> 
	  <td class="catrow" colspan="5" align="center"><span class="catrowtext">{L_MOD_CP}</span> 
	  </td>
	</tr>
	<tr> 
	  <td class="row1" colspan="5" align="center"><span class="mediumtext">{L_MOD_CP_EXPLAIN}</span></td>
	      ...
	      <tr align="center"> 
            <td width="4%"height="35" class="toprow"><span class="toprowtext">&nbsp;</span></td>
	        <td height="35" class="toprow"><span class="toprowtext">&nbsp;{L_TOPICS}&nbsp;</span></td>
	        <td width="8%"height="35" class="toprow"><span class="toprowtext">&nbsp;{L_REPLIES}&nbsp;</span></td>
	        <td width="17%"height="35" class="toprow"><span class="toprowtext">&nbsp;{L_LASTPOST}&nbsp;</span></td>
	        <td width="5%"height="35" class="toprow"><span class="toprowtext">&nbsp;{L_SELECT}&nbsp;</span></td>
	</tr>
	<!-- BEGIN topicrow -->
	<tr> 
	  ...
	  <td class="row2" align="center" valign="middle"><span class="mediumlink">{topicrow.REPLIES}</span></td>
	...
	<!-- END topicrow -->
	<tr align="right"> 
	  <td height="34" class="catrow" colspan="5"> {S_HIDDEN_FIELDS} 
  ...
  <table width="98%" cellspacing="2" border="0" align="center" cellpadding="2">
    <tr> 
	<td align="left" valign="middle"><span class="smalltext">{PAGE_NUMBER}</span></td>
	<td align="right" valign="top" nowrap><span class="smalltext">{S_TIMEZONE}</span><br><span class="smalltext">{PAGINATION}</span></td>
  </tr>
</table>
</form>
