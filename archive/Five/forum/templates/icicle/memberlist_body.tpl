  ...
  <tr> 
    <td class="tableborder">
        <table width="100%" cellpadding="7" cellspacing="1" border="0">
          <tr> 
            <td height="35" class="toprow">&nbsp;</td>
            <td height="35" class="toprow"> 
          ...
          <tr> 
            ...
            <td class="row2" align="center"><span class="mediumtext"><a href="{memberrow.U_VIEWPROFILE}" class="mediumlink">{memberrow.USERNAME}</a></span></td>
            <td class="row1" align="center" valign="middle">&nbsp;{memberrow.EMAIL_IMG}&nbsp;</td>
            <td class="row2" align="center" valign="middle"><span class="mediumtext">{memberrow.FROM}</span></td>
            <td class="row1" align="center" valign="middle"><span class="smalltext">{memberrow.JOINED}</span></td>
            <td class="row2" align="center" valign="middle"><span class="mediumtext">{memberrow.POSTS}</span></td>
            <td class="row1" align="center">&nbsp;{memberrow.WWW_IMG}&nbsp;</td>
          </tr>
          <!-- END memberrow -->
          <tr> 
            <td height="34" class="catrow" colspan="7"><span class="catrowtext">&nbsp;</span></td>
          </tr>
        </table>
