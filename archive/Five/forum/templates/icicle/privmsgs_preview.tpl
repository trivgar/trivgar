...
<table border="0" cellpadding="7" cellspacing="1" width="100%">
  <tr align="center"> 
    <td height="34" class="catrow" colspan="2"><span class="catrowtext">{L_PREVIEW}</span></td>
  </tr>
  <tr> 
	<td class="row2"><span class="mediumtext">{L_FROM}:</span></td>
	<td width="100%" class="row2"><span class="mediumtext">{MESSAGE_FROM}</span></td>
  </tr>
  <tr> 
	<td class="row2"><span class="mediumtext">{L_TO}:</span></td>
	<td width="100%" class="row2"><span class="mediumtext">{MESSAGE_TO}</span></td>
  </tr>
  <tr> 
	<td class="row2"><span class="mediumtext">{L_POSTED}:</span></td>
	<td width="100%" class="row2"><span class="mediumtext">{POST_DATE}</span></td>
  </tr>
  <tr> 
