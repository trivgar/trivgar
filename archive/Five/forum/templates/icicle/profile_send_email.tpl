...
<form action="{S_POST_ACTION}" method="post" name="post" onSubmit="return checkForm(this)">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%">
	      <tr align="center"> 
            <td height="34" class="catrow" colspan="2" height="25"><span class="catrowtext">{L_SEND_EMAIL_MSG}</span></td>
	</tr>
	<tr> 
		<td height="35" class="toprow" width="22%"><span class="toprowtext"><b>{L_RECIPIENT}</b></span></td>
		<td height="35" class="toprow" width="78%"><span class="toprowtext"><b>{USERNAME}</b></span> </td>
	</tr>
	<tr> 
		<td class="row1" width="22%"><span class="mediumtext"><b>{L_SUBJECT}</b></span></td>
		<td class="row2" width="78%"><span class="mediumtext"><input type="text" name="subject" size="45" maxlength="100" style="width:450px" tabindex="2" value="{SUBJECT}"></span> </td>
	</tr>
	<tr> 
		...
		<td class="row2"><span class="mediumtext"><textarea name="message" rows="25" cols="40" wrap="virtual" style="width:500px" tabindex="3">{MESSAGE}</textarea></span></td>
	</tr>
	<tr> 
	...
	<tr>
		...
		&nbsp;<input type="submit" tabindex="6" name="submit" value="{L_SEND_EMAIL}"></td>
	</tr>
</table>
</td>
</tr>
