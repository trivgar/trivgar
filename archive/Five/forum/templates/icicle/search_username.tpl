    ...
    <tr> 
      <td class="tableborder"> 
        <table width="100%" border="0" cellspacing="1" cellpadding="7">
          <tr> 
            <td height="34" class="catrow" align="center"><span class="catrowtext">{L_SEARCH_USERNAME}</span></td>
          </tr>
          <tr> 
            <td valign="top" class="row1"><span class="mediumtext"><br>
              ...
              <br>
              <span class="mediumtext"><a href="javascript:window.close();" class="mediumtext">{L_CLOSE_WINDOW}</a></span></td>
          </tr>
        </table>
      </td>
    </tr>
