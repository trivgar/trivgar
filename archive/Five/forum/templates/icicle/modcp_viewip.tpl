...
<table width="100%" cellpadding="7" cellspacing="1" border="0">
  <tr> 
	<thheight="35" class="toprow"><span class="toprowtext">{L_IP_INFO}</span></th>
  </tr>
  <tr> 
	<td height="34" class="catrow"><span class="catrowtext">{L_THIS_POST_IP}</span></td>
  </tr>
  <tr> 
	<td class="row1"> 
  ...
  <tr> 
	<td height="34" class="catrow"><span class="catrowtext">{L_OTHER_USERS}</span></td>
  </tr>
  <!-- BEGIN userrow -->
  <tr> 
	<td class="row2"> 
  ...
  <!-- END userrow -->
  <tr> 
	<td height="34" class="catrow"><span class="catrowtext">{L_OTHER_IPS}</span></td>
  </tr>
  <!-- BEGIN iprow -->
  <tr> 
