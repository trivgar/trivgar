	      ...
	      <table cellspacing="1" cellpadding="7" border="0" align="center">
            <tr> 
		<td colspan="4" align="center"height="34" class="catrow"><span class="catrowtext"><b>{POLL_QUESTION}</b></span></td>
	  </tr>
	  <tr> 
			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="templates/icicle/images/vote_lcap.gif" width="4" alt="" height="12"></td>
					...
					<td><img src="templates/icicle/images/vote_rcap.gif" width="4" alt="" height="12"></td>
				  </tr>
				</table>
			  </td>
	  ...
	  <tr> 
		<td colspan="4" align="center" class="row2"><span class="mediumtext"><b>Total Votes : {TOTAL_VOTES}</b></span></td>
	  </tr>
	</table><br>