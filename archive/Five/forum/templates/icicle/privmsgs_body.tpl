		...
		<tr> 
		  <td colspan="3" width="100%" class="row2">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td class="toprow"><img src="templates/icicle/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}"></td>
			  </tr>
			</table>
		  </td>
		</tr>
  ...
  <tr> 
    <td class="tableborder">
        <table width="100%" cellspacing="1" cellpadding="7" border="0" align="center">
          <tr> 
	  <td align="left" valign="middle" class="row1">{POST_PM_IMG}</td>
	  <td align="left" width="100%" class="row2">&nbsp;<span class="smalltext"><a href="{U_INDEX}" class="smalllink">{L_INDEX}</a></span></td>
	  <td align="right" nowrap class="row1"><span class="smalltext">{L_DISPLAY_MESSAGES}: 
	...
	<tr> 
	  ...
	  <td width="55%" valign="middle" class="row2"><span class="topictitle">&nbsp;<a href="{listrow.U_READ}" class="topiclink">{listrow.SUBJECT}</a></span></td>
	  ...
	  <td width="15%" align="center" valign="middle" class="row2"><span class="smalltext">{listrow.DATE}</span></td>
